...
// if's responsaveis pelo fim de curso do motor, irão receber um sinal para processar o fim de curso do motor, e assim  fazendo o desligamento e o acionamento da trava
void travas()
{
    //responsavel pelo final de curso do motor, irão receber um sinal para processar 
